...
def create(width=142, height=428, rotation=0, spi_id=0, sck=18, mosi=19, cs=17, dc=20, rst=21, blk=14):
    """
    创建NV3007实例的便捷函数
    ...
    返回:
        NV3007实例
    """
    spi = SPI(spi_id, baudrate=100_000_000, polarity=1, phase=1, bits=8, sck=Pin(sck), mosi=Pin(mosi))
